...
p "pum".pluralize_portuguese
p "mãe".pluralize_portuguese
p "coração".pluralize_portuguese
p "cor".pluralize_portuguese
p "açúcar".pluralize_portuguese
p "jornal".pluralize_portuguese
p "papel".pluralize_portuguese
p "infantil".pluralize_portuguese
p "lençol".pluralize_portuguese
p "ás".pluralize_portuguese
p "lápis".pluralize_portuguese
